// Package Submission Code generated by swaggo/swag. DO NOT EDIT
package Submission

import "github.com/swaggo/swag"

const docTemplateSubmission = `{
...
// SwaggerInfoSubmission holds exported Swagger Info so clients can modify it
var SwaggerInfoSubmission = &swag.Spec{
	Version:          "1.0",
	Host:             "localhost:80",
	BasePath:         "/api/v1",
	Schemes:          []string{},
...
func init() {
	swag.Register(SwaggerInfoSubmission.InstanceName(), SwaggerInfoSubmission)
}
